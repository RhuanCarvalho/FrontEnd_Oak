import "./ShowGenomaGraphCandleTradeOfTest.css";
...
export function ShowGenomaGraphCandleTradeOfTest(props: IProps) {
    ...
    const getDataGraph = async () => await api
        .get(`getShowGraphTradeOfTest/${props.historyTrade.id}`)
