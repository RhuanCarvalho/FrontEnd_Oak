import "./ShowGenomaGraphEvulotionMoneyInDayOfTest.css";
...
export function ShowGenomaGraphEvulotionMoneyInDayOfTest(props: IProps) {
    ...
    const getDataGraph = async () => {
        const response = await api.get(`getGraphShowEvulotionMoneyInDayOfTest/${props.id_training}`);
